...
// ═══════════════════════════════════════════════════════════
// THE AI CENTAUR — Hub v4 · data refreshed Aug 22, 2026
// ═══════════════════════════════════════════════════════════
...
// ─── MODELS ───
const MODELS=[
  {id:"fable-5",name:"Claude Fable 5",short:"Fable 5",company:"Anthropic",color:"#F59E0B",reasoning:97,coding:95,writing:95,math:94,speed:45,knowledge:95,elo:1525,input_price:10,output_price:50,context:1000000,open:false,best:"Deepest reasoning; built for long, complex multi-step work. #1 on Arena (Aug 2026)"},
  {id:"opus-4.8",name:"Claude Opus 4.8",short:"Opus 4.8",company:"Anthropic",color:"#FBBF24",reasoning:94,coding:96,writing:94,math:91,speed:60,knowledge:93,elo:1510,input_price:5,output_price:25,context:1000000,open:false,best:"Coding and agent reliability — #1 on Arena's separate coding board"},
  {id:"gpt-5.6",name:"GPT-5.6",short:"GPT-5.6",company:"OpenAI",color:"#22C55E",reasoning:93,coding:92,writing:91,math:94,speed:65,knowledge:93,elo:null,input_price:5,output_price:30,context:1000000,open:false,best:"OpenAI's new flagship family (Sol/Terra/Luna) — broad skills, biggest ecosystem"},
  {id:"gemini-3.1",name:"Gemini 3.1 Pro",short:"Gem 3.1",company:"Google",color:"#3B82F6",reasoning:92,coding:90,writing:90,math:92,speed:80,knowledge:92,elo:1500,input_price:2,output_price:12,context:1000000,open:false,best:"Frontier quality at a mid-tier price; strong vision (rates double past 200K tokens)"},
  {id:"sonnet-4.6",name:"Claude Sonnet 4.6",short:"Sonnet 4.6",company:"Anthropic",color:"#F97316",reasoning:89,coding:91,writing:92,math:87,speed:82,knowledge:89,elo:null,input_price:3,output_price:15,context:200000,open:false,best:"Best everyday value — strong writing and coding at a fraction of flagship pricing"},
  {id:"grok-4.5",name:"Grok 4.5",short:"Grok 4.5",company:"xAI",color:"#EF4444",reasoning:90,coding:86,writing:84,math:91,speed:75,knowledge:87,elo:null,input_price:null,output_price:null,context:null,open:false,best:"xAI's newest — ranked on Arena's agent and vision boards; real-time X integration"},
  {id:"kimi-k3",name:"Kimi K3",short:"Kimi K3",company:"Moonshot AI",color:"#EAB308",reasoning:88,coding:93,writing:82,math:87,speed:60,knowledge:86,elo:null,input_price:null,output_price:null,context:1000000,open:true,best:"First open-weight model to lead a major coding arena (est. 2.8T parameters)"},
  {id:"deepseek-v4",name:"DeepSeek V4 Flash",short:"DS V4",company:"DeepSeek",color:"#A855F7",reasoning:86,coding:88,writing:80,math:89,speed:85,knowledge:84,elo:null,input_price:0.14,output_price:0.28,context:1000000,open:true,best:"Cheapest capable API by far — 1M-token context for pennies"},
  {id:"glm-5.2",name:"GLM-5.2",short:"GLM-5.2",company:"Zhipu AI",color:"#06B6D4",reasoning:84,coding:85,writing:78,math:83,speed:70,knowledge:82,elo:null,input_price:1.4,output_price:4.4,context:null,open:false,best:"Zhipu's budget workhorse; strong price-to-performance and Chinese-language skills"},
  {id:"llama-4",name:"Llama 4 Maverick",short:"Llama 4",company:"Meta",color:"#60A5FA",reasoning:82,coding:82,writing:78,math:80,speed:78,knowledge:81,elo:null,input_price:null,output_price:null,context:1000000,open:true,best:"Meta's open weights — free to self-host and modify"},
];
...
const FEATURES=[
  {key:"voice_in",label:"🎤 Voice Input",models:["fable-5","opus-4.8","sonnet-4.6","gpt-5.6","gemini-3.1","grok-4.5","deepseek-v4","kimi-k3"]},
  {key:"voice_out",label:"🔊 Voice Output",models:["gpt-5.6","gemini-3.1","grok-4.5"]},
  {key:"image_gen",label:"🖼️ Image Generation",models:["gpt-5.6","gemini-3.1","grok-4.5"]},
  {key:"image_in",label:"📷 Image Input",models:["fable-5","opus-4.8","sonnet-4.6","gpt-5.6","gemini-3.1","grok-4.5","deepseek-v4","kimi-k3","glm-5.2","llama-4"]},
  {key:"video_gen",label:"🎬 Video Generation",models:["gpt-5.6","gemini-3.1","grok-4.5"]},
  {key:"pdf",label:"📄 PDF Upload",models:["fable-5","opus-4.8","sonnet-4.6","gpt-5.6","gemini-3.1","grok-4.5","deepseek-v4","kimi-k3"]},
  {key:"web",label:"🌐 Web Search",models:["fable-5","opus-4.8","sonnet-4.6","gpt-5.6","gemini-3.1","grok-4.5","deepseek-v4","kimi-k3"]},
  {key:"code_exec",label:"💻 Code Execution",models:["fable-5","opus-4.8","sonnet-4.6","gpt-5.6","gemini-3.1","deepseek-v4","kimi-k3"]},
  {key:"computer",label:"🖥️ Computer Use",models:["fable-5","opus-4.8","sonnet-4.6","gpt-5.6","gemini-3.1"]},
  {key:"memory",label:"🧠 Cross-Chat Memory",models:["fable-5","opus-4.8","sonnet-4.6","gpt-5.6","gemini-3.1","grok-4.5"]},
  {key:"api",label:"🔌 API Access",models:["fable-5","opus-4.8","sonnet-4.6","gpt-5.6","gemini-3.1","grok-4.5","deepseek-v4","kimi-k3","glm-5.2","llama-4"]},
  {key:"free",label:"🆓 Free Tier",models:["sonnet-4.6","gpt-5.6","gemini-3.1","grok-4.5","deepseek-v4","kimi-k3","glm-5.2","llama-4"]},
];
...
const BIG_QUESTIONS=[
  ...
  ],prompts:["A musician shows you a beautiful song. AI composed the melody, wrote lyrics, generated backing. They arranged and performed it. Is it 'their' song?","A publisher advertises 'written by humans, not AI' at a premium price. Would you pay extra? Could you even tell the difference?"],facts:[{num:"81%",label:"Celebrity deepfake increase (Q1 2025 vs all 2024)",comparison:"One quarter produced more celebrity fakes than the entire previous year.",source:"Surfshark"},{num:"50+",label:"NeurIPS 2025 papers with fabricated citations",comparison:"The top AI conference corrupted by the technology it studies.",source:"GPTZero"}],misconceptions:[{claim:"AI can't be truly creative",reality:"Depends on your definition. Whether AI combinations count as 'creativity' is philosophical, not technical."}],sources:[{name:"Surfshark Research",type:"Research",url:"https://surfshark.com/research/study/deepfake-statistics"}]},

  {title:"Education, Cognition & Development",tagline:"Are we building skills or outsourcing them? (And should we be asking that about ourselves first?)",subtopics:[
    {t:"Assessment collapse",desc:"Traditional ways of testing whether students learned something — essays, homework, take-home exams, research papers — are breaking down because AI can produce passable work in all of these formats. Teachers can't reliably tell AI-generated work from student work, and detection tools are unreliable. But there are real solutions: in-class testing, handwritten essays, oral exams, and proctored writing sessions actually measure what students can do without AI. The challenge isn't lack of options — it's whether schools will invest the time and structure to use them.",example:"A college professor gave a take-home writing assignment. Three students submitted AI-generated essays that received B+ grades. When confronted, the students argued — not unreasonably — that learning to use AI tools IS a relevant skill. The professor had no policy. This scene is playing out everywhere. The fix isn't catching cheaters — it's redesigning assessment so the answer isn't outsourceable to a chatbot."},
    {t:"Skill atrophy and concentration loss",desc:"When you outsource a cognitive task to AI, you don't practice that skill. Writing, mathematical reasoning, critical reading, sustained focus — these aren't just academic exercises. They develop through practice. And it's not just skill atrophy: research suggests AI-mediated work may also erode the capacity for sustained attention, since AI delivers answers instantly without requiring focus. One counter-practice gaining traction: journaling. Putting thoughts down on paper forces you to organize and develop your own mind, not just receive someone else's.",example:"Drivers who rely on GPS for years lose the ability to navigate unfamiliar areas. Pilots who rely on autopilot become less skilled at manual flying. The same principle applies to AI: if you never practice writing because AI writes for you, your ability to organize and express complex thoughts may atrophy. Whether this matters depends on whether the skill becomes obsolete or merely uncommon."},
    {t:"AI tutoring potential — the equity question",desc:"On the positive side, AI could be the most powerful educational equalizer ever created. A patient, infinitely available tutor that adapts to any student's pace, explains concepts in multiple ways, and provides instant feedback. For students in under-resourced schools, rural districts, or families that can't afford private tutoring — or for kids interested in topics no local teacher can teach (advanced math, rare languages, niche subjects) — this could open doors that were always locked. Current limitations (kids who struggle most often get more confused by AI explanations) will likely improve as models get better. The real question is whether this potential gets realized equitably or whether wealthy schools deploy AI well while underfunded schools deploy it poorly.",example:"A homeschooled kid in rural Montana can now learn organic chemistry from an AI tutor that adapts to their pace — no traveling, no expensive tutor. A kid whose parents can't help with calculus homework has 24/7 access to explanations. These are real wins. But the same tools, deployed badly in overcrowded classrooms with no teacher support, could leave struggling kids more behind."},
    {t:"Critical thinking — and whose problem is this?",desc:"If AI can instantly produce a well-structured argument on any topic, there's less incentive to develop your own analytical skills. The ability to evaluate claims, identify logical fallacies, weigh evidence — arguably more important in an AI era, not less — yet AI may undermine the very learning processes that develop these skills. But here's an honest question for parents: this isn't just a kids' problem. We're using AI for analysis, writing, and decisions too. Are we modeling the critical thinking we want them to develop, or are we outsourcing our own thinking and then telling them not to?",example:"UNESCO has framed this as a 'crisis of knowing' — the concern isn't just that students cheat on homework, but that the process of struggling with ideas, making mistakes, and revising your thinking IS the learning. Skip that process with AI, and you get the product (a finished essay) without the growth (learning to think clearly). The same applies to adults — if we let AI think for us, we lose the muscle too."},
    {t:"First AI-native generation",desc:"Children starting school today will never know a world without AI assistants. They'll grow up treating AI as a default tool for writing, research, problem-solving, and even social interaction. We have no historical precedent for what this means for cognitive development, attention spans, social skills, or identity formation. The hard question on the table: should we shield our kids from AI until age 16, the way Australia did with social media for under-16s? Or does that just leave them unprepared for a world where AI is everywhere?",example:"40% of US adults already use generative AI regularly. For kids growing up now, AI will be as natural as Google. The question nobody can answer yet: what skills are being developed, and what's being lost? By the time we have data, a generation will have grown up as the experiment — including ours."},
  ],prompts:["Half the class uses AI for homework. The teacher can't tell who's learning anymore. They want to ban AI tools entirely. Another parent argues AI is the future and kids need to learn WITH it. You're the tiebreaker. What do you propose?","Your child's school adds AI tutors to homework time. Initial test scores improve, but teachers report kids are less engaged in class discussions. What do you advocate for?","Your 14-year-old asks ChatGPT for advice about a problem with a friend instead of talking to you or a family member. How do you respond?","A wealthy private school gives every student a personalized AI tutor. The local public school can't afford it. Should public funding cover AI tutors so the gap doesn't widen?","Your kid says: 'Why should I learn to write essays if AI can do it?' What's your honest answer?","Should we shield our kids from AI until age 16, like Australia did with social media? Or does that just leave them unprepared?"],facts:[{num:"40%",label:"US adults using gen AI by late 2024",comparison:"Nearly half of working-age Americans. Whatever we decide for our kids, we should ask the same of ourselves.",source:"Bick et al., St. Louis Fed, 2024"},{num:"49%",label:"Gen Z saying AI reduced their degree's value",comparison:"Half the youngest workers feel education was devalued before their career started.",source:"National University, 2025"},{num:"23%",label:"Workers using AI weekly for work",comparison:"About 1 in 4 — as routine as checking email. The 'training-with-AI' is happening at work, not in classrooms.",source:"Bick et al., 2024"},{num:"17-33%",label:"Hallucination rate in legal AI tools",comparison:"If your child's AI tutor made up facts 1 in 4 times, you'd want to know. Models still make confident mistakes.",source:"Stanford HAI, 2025"}],misconceptions:[{claim:"Students using AI are just cheating",reality:"Deeper question: does our assessment system still measure learning? In-class testing and handwritten work measure what kids actually know — redesigning HOW we test may matter more than banning."},{claim:"AI tutoring will fix educational inequality",reality:"It MIGHT — but only with deliberate effort. Current tools benefit kids with strong fundamentals most, potentially widening gaps unless schools and parents actively push the other way."},{claim:"We just need to ban AI in schools",reality:"Phones were banned for years; kids used them anyway. The question is what AI use should look like, not whether it will exist."},{claim:"This is mainly a kids' problem",reality:"Adults use AI more than kids in many cases. If we outsource our own analysis while telling kids to think for themselves, we're modeling something different from what we're saying."}],sources:[{name:"UNESCO — AI in Education",type:"Primary",url:"https://www.unesco.org/en/digital-education/artificial-intelligence"},{name:"Stanford HAI — AI Index",type:"Primary",url:"https://hai.stanford.edu/ai-index"},{name:"Bick, Blandin & Deming (NBER)",type:"Research",url:"https://www.nber.org/papers/w32966"},{name:"OECD — AI in Education",type:"Primary",url:"https://www.oecd.org/en/topics/digital-education.html"},{name:"Common Sense Media",type:"Research",url:"https://www.commonsensemedia.org"},{name:"Hechinger Report",type:"Analysis",url:"https://hechingerreport.org"},{name:"Ethan Mollick — One Useful Thing",type:"Analysis",url:"https://www.oneusefulthing.org"},{name:"Pew Research",type:"Analysis",url:"https://www.pewresearch.org"}]},

  // ENVIRONMENT — updated Aug 2026 from the Meeting #2 fact-checked content
  {title:"Environmental & Physical Costs",tagline:"Energy, water, e-waste, and computation at scale. The framing question: if data centers are coming anyway, what conditions can communities demand?",subtopics:[
    {t:"Per-query vs aggregate energy",desc:"A single AI query's energy use varies wildly depending on the model. OpenAI says ChatGPT averages around 0.34 Wh per query (about an oven for one second). But newer 'reasoning' models like GPT-5 average closer to 18.9 Wh per query, with complex prompts hitting 45+ Wh. The honest answer is: per-query energy is small for simple uses, significant for advanced ones, and the question isn't 'AI vs. nothing' — it's 'AI vs. the other things we choose to spend energy on.'",example:"For comparison: a Google search uses ~0.3 Wh, streaming Netflix for an hour uses ~80 Wh, an hour of console gaming uses ~150 Wh, and a 30-minute TV show uses ~150-300 Wh. So a typical AI query uses less energy than 30 seconds of streaming — but a heavy AI session can rival watching a movie."},
    {t:"Water use and cooling alternatives",desc:"Data centers generate enormous heat from millions of processors running simultaneously. The most common cooling method — evaporative cooling — works like sweat: water absorbs heat and evaporates. About 80% is lost to the atmosphere. But this isn't the only option. Closed-loop water systems can reduce freshwater use by up to 70% (but use more electricity). Air cooling uses no water (but 30-50% more electricity). Immersion cooling submerges servers in non-conductive synthetic fluid (newest, most expensive, used by some advanced AI data centers). Microsoft launched a zero-water cooling design in 2025. The technology exists — it's a question of cost and policy.",example:"Google's data centers used 6.1 billion gallons of water in 2023. In The Dalles, Oregon (population 16,000), Google's data center used a quarter of the entire city's water supply. Meanwhile, Santa Clara, CA now requires new data centers to use carbon-free electricity AND prohibits water-intensive once-through cooling. Local rules can change the equation."},
    {t:"E-waste from hardware refresh cycles",desc:"AI chips become outdated quickly as newer, more powerful versions release. Data centers replace hardware every 3-5 years. This is a fair challenge: we throw out phones every 2-3 years, laptops every 4-5 years. Data center hardware isn't fundamentally different — what's different is the volume. A single hyperscale data center can have 100,000+ servers being replaced on rolling cycles, generating e-waste at industrial scale. The concern is less about WHETHER to refresh and more about whether materials get recovered and recycled responsibly.",example:"For context on water in chip manufacturing: a smartphone takes ~3,400 gallons of water across all components, a pair of jeans ~1,800 gallons, a single car ~39,000 gallons. AI chip manufacturing isn't uniquely water-intensive per chip — it's the volume (10M gallons/day per fab plant) and the requirement for ultrapure water that adds up."},
    {t:"Carbon emissions by energy source",desc:"The carbon footprint of AI depends enormously on WHERE the data center is located and how it's powered. The same query produces 100× more CO2 in a coal-heavy grid than in one running on hydro or nuclear. As of 2024, US data centers got 40%+ from natural gas, 24% from renewables, 20% from nuclear, and 15% from coal. The energy SOURCE matters more than the energy AMOUNT. This is why some communities are starting to require clean-energy commitments as a condition of approval.",example:"France processes a query at 0.1g of CO2 (mostly nuclear). India processes the same query at 10g of CO2 (mostly coal). Norway runs almost entirely on hydropower. The same AI workload has dramatically different climate impact depending on the grid powering it."},
    {t:"Local community impact",desc:"Data centers don't affect the planet evenly — they concentrate impact in specific communities. Towns near data centers experience grid strain (which raises electricity prices for residents), water competition, noise, and changes to land use. Tax revenue flows in, but so do costs. The question isn't 'are data centers good or bad?' — it's 'what do communities get in return for hosting them, and who bears the costs?'",example:"In Loudoun County, Virginia (the world's data center capital), data centers contribute nearly $900M in annual tax revenue — close to the entire county operating budget. Meanwhile, average residential electricity bills in western Maryland rose $18/month partly due to data center demand on the shared grid. In 2024, a Fairfax County incident saw 60 data centers switch to backup generation, dropping 1,500 MW of load — nearly enough to trigger a regional grid failure."},
  ],prompts:["A tech company wants to build a data center in your county. They promise 50 construction jobs and $12M in annual tax revenue. It will use 3 million gallons of water per day from a reservoir that's already stressed. Public comment is open. What do you say?","OpenAI announces a 1.2 GW data center campus in your state. The governor calls it 'jobs and innovation.' Climate activists call it 'a fossil fuel lock-in.' How do you want your representative to vote?","Should AI companies be required to disclose the carbon footprint of every query — like nutrition labels on food? Would you change your behavior if you could see it?","If we accept that AI is here to stay, what specific conditions should communities require before approving data centers? Clean energy mandates? Water recycling? Local hiring? Revenue sharing?"],facts:[{num:"415 TWh",label:"Global data center electricity (2024)",comparison:"About 1.5% of global electricity. Equivalent to South Africa's total use, or ~38 million US homes.",source:"IEA Energy and AI Report, 2025"},{num:"945 TWh",label:"Projected by 2030",comparison:"More than doubles in 6 years — roughly Japan's current total consumption. AI is the primary driver.",source:"IEA, April 2025"},{num:"0.34-19 Wh",label:"Per-query AI energy (range)",comparison:"Older models: 0.34 Wh. Newer reasoning models (GPT-5): ~18.9 Wh average, up to 45 Wh for complex queries.",source:"OpenAI / Univ. of Rhode Island, 2025"},{num:"5M gal/day",label:"Water use — large AI data center",comparison:"A town of 50,000. ~80% evaporates with current cooling. Closed-loop cuts 70% but uses more electricity.",source:"Brookings / EESI, 2025"},{num:"44%",label:"US data center power from low-carbon sources",comparison:"24% renewables + 20% nuclear. The other 56% is fossil — mostly natural gas (40%+), some coal.",source:"IEA / Pew Research, 2024"},{num:"12%/yr",label:"Growth in data center electricity demand",comparison:"4× faster than total electricity demand. One of few sectors where emissions are RISING.",source:"IEA, 2025"}],misconceptions:[{claim:"AI is boiling the oceans",reality:"Currently 1.5% of global electricity and ~1% of CO2. Real but modest. The concern is the trajectory — and the local concentration in specific communities."},{claim:"It's no big deal",reality:"12% annual growth — 4× faster than total electricity demand. One of the few sectors with rising emissions while everything else trends down."},{claim:"Renewables solve everything",reality:"Partially. Sun-rich regions are often water-poor — solar in the desert means more cooling water. It's a tradeoff that requires deliberate planning."},{claim:"There's nothing local communities can do",reality:"Santa Clara requires carbon-free power for new data centers. States are passing disclosure and renewable mandates. Communities have leverage at the approval stage — if they use it."}],sources:[{name:"IEA Energy and AI Report",type:"Primary",url:"https://www.iea.org/reports/energy-and-ai"},{name:"Brookings — AI, Data Centers, and Water",type:"Primary",url:"https://www.brookings.edu/articles/ai-data-centers-and-water/"},{name:"Pew Research — US Data Center Energy",type:"Analysis",url:"https://www.pewresearch.org/short-reads/2025/10/24/what-we-know-about-energy-use-at-us-data-centers-amid-the-ai-boom/"},{name:"Carbon Brief — AI Energy in Context",type:"Analysis",url:"https://www.carbonbrief.org/ai-five-charts-that-put-data-centre-energy-use-and-emissions-into-context/"},{name:"Lincoln Institute — Land & Water Impacts",type:"Research",url:"https://www.lincolninst.edu/publications/land-lines-magazine/articles/land-water-impacts-data-centers/"},{name:"EESI — Data Centers and Water",type:"Research",url:"https://www.eesi.org/articles/view/data-centers-and-water-consumption"},{name:"Epoch AI — ChatGPT Energy Use",type:"Research",url:"https://epoch.ai/gradient-updates/how-much-energy-does-chatgpt-use"}]},
...
const SAFETY_DATA=[{company:"Anthropic",models:"Claude Fable 5, Opus 4.8",color:"#F59E0B",grade:"C+",highlights:["Top score (2.66/4.0) — led 5 of 6 evaluation domains","Most transparent on risk assessment","Responsible Scaling Policy"],concerns:["A C+ is still the industry's BEST grade","Panel: capabilities outpacing safeguards everywhere"]},{company:"OpenAI",models:"GPT-5.6 family (Sol, Terra, Luna)",color:"#22C55E",grade:"C",highlights:["Safety framework with defined risk levels","Pre-deployment testing protocols"],concerns:["Slipped a letter tier from the prior edition","Continued safety-researcher departures"]},{company:"Google DeepMind",models:"Gemini 3.1 Pro, 3 Flash",color:"#3B82F6",grade:"C",highlights:["Frontier Safety Framework","Strong internal alignment team"],concerns:["Competitive pressure to ship fast","Less transparent than Anthropic"]},{company:"Meta",models:"Llama 4 Maverick",color:"#06B6D4",grade:"D+",highlights:["Open weights enable community research"],concerns:["Can't recall open-weight models once released","Limited post-deployment monitoring"]},{company:"xAI",models:"Grok 4.5",color:"#EF4444",grade:"F",highlights:["Basic model cards"],concerns:["Fell to a failing grade in 2026","Minimal safety framework"]},{company:"DeepSeek",models:"DeepSeek V4",color:"#A855F7",grade:"F",highlights:["Open-weight releases"],concerns:["Minimal safety documentation","Grade fell from D to F"]}];

const NEWS_ITEMS=[{headline:"EU Begins Enforcing AI Act: Chatbots Must Disclose, Deepfakes Must Be Labeled",date:"Aug 2026",source:"European Commission",topic:1,url:"https://digital-strategy.ec.europa.eu/en/news/commission-starts-enforcing-ai-act-rules-and-new-transparency-requirements-2-august"},{headline:"Data Centers Become a 'Sleeper Issue' in the US Midterm Elections",date:"Aug 2026",source:"CNBC",topic:7,url:"https://www.cnbc.com/2026/08/20/ai-data-center-election-backlash.html"},{headline:"NYC Parents Rally for a 2-Year Moratorium on AI in Public Schools",date:"Aug 2026",source:"CS Monitor",topic:6,url:"https://www.csmonitor.com/USA/Education/2026/0807/ai-risks-schools-students"},{headline:"Data Breaches Surge as AI Powers Phishing and Deepfake Job Interviews",date:"Aug 2026",source:"CNBC",topic:2,url:"https://www.cnbc.com/2026/08/14/data-breaches-surge-2026-ai-cyberattacks.html"},{headline:"Students From All 50 States Draft a National Framework for AI in Schools",date:"Aug 2026",source:"AASA / Day of AI",topic:6,url:"https://www.aasa.org/news-media/news/2026/08/03/students-produce-national-framework-for-ai-in-america's-schools"},{headline:"33 States Now Regulate Political Deepfakes; 48 Cover Explicit Fakes",date:"Aug 2026",source:"Ballotpedia",topic:3,url:"https://stackcyber.com/posts/ai-deepfake-laws"},{headline:"No AI Company Scores Above C+ on the Summer 2026 Safety Index",date:"Jul 2026",source:"Future of Life Inst.",topic:0,url:"https://www.techtimes.com/articles/320959/20260719/ai-safety-grades-are-no-lab-tops-c-best-ones-are-retreating.htm"},{headline:"Kimi K3: First Open-Weight Model to Lead a Major Coding Leaderboard",date:"Jul 2026",source:"Moonshot AI",topic:1,url:"https://datasciencedojo.com/blog/kimi-k3-vs-claude-fable-5/"},{headline:"US Export Controls Briefly Took a Frontier AI Model Offline Worldwide",date:"Jun-Jul 2026",source:"US Commerce Dept.",topic:1,url:"https://www.morphllm.com/llm-api"},{headline:"IEA: Data Centers to Double Energy Use by 2030",date:"Apr 2025",source:"IEA",topic:7,url:"https://www.iea.org/reports/energy-and-ai"},{headline:"Young Tech Workers See 3-Point Unemployment Spike",date:"Aug 2025",source:"Goldman Sachs",topic:4,url:"https://www.goldmansachs.com/insights/articles/how-will-ai-affect-the-global-workforce"},{headline:"Stanford: Legal AI Tools Hallucinate 17-33% of the Time",date:"2025",source:"Stanford",topic:8,url:"https://dho.stanford.edu/wp-content/uploads/Legal_RAG_Hallucinations.pdf"}];
...
export default function AIcentaur(){
  ...
  const NEEDS_KEY_MSG="Running this live test on the public site requires an Anthropic API key. Paste one below (it stays in your browser only — never saved or sent anywhere except Anthropic), or skip it and use the free comparison sites underneath. No key needed for those.";
  const runTest=async()=>{setTestLoading(true);setTestResult("");try{
    ...
    const r=await fetch("https://api.anthropic.com/v1/messages",{method:"POST",headers,body:JSON.stringify({model:"claude-sonnet-4-6",max_tokens:1000,messages:[{role:"user",content:testPrompt}]})});
    const d=await r.json();
    if(d.error){if(!apiKey.trim()){setShowKey(true);setTestResult(NEEDS_KEY_MSG)}else{setTestResult("Error: "+(d.error.message||"request failed — check that your key is valid"))}}
    else{setTestResult(d.content?.filter(i=>i.type==="text").map(i=>i.text).join("\n")||"No response")}
  }catch(e){if(!apiKey.trim()){setShowKey(true);setTestResult(NEEDS_KEY_MSG)}else{setTestResult("Error: "+e.message)}}
  ...
  const SubCards=({items})=>(<div style={{display:"grid",gridTemplateColumns:cols2,gap:F?12:16,marginBottom:24}}>
  ...
  const PageTitle=({children,sub:subtitle})=>(<><h2 style={{fontSize:isMobile?(F?24:27):(F?32:36),fontWeight:F?800:400,marginBottom:4}}>{children}</h2>{subtitle&&<p style={{fontSize:14,color:t.textSec,marginBottom:24,lineHeight:1.7,fontStyle:F?"normal":"italic"}}>{subtitle}</p>}</>);
  ...
  return(
    <div style={{minHeight:"100vh",background:t.bgGrad,color:t.text,fontFamily:t.font,transition:"all 0.5s",position:"relative",overflow:"hidden"}}>
      ...
      {/* NAV */}
      <div style={{maxWidth:900,margin:"0 auto",padding:isMobile?"14px 20px":"14px 40px",display:"flex",justifyContent:"space-between",alignItems:"center"}}>
      ...
      <div style={{maxWidth:900,margin:"0 auto",padding:isMobile?"0 20px 60px":"0 40px 60px"}}>

      {/* HOME */}
      {page==="home"&&(<div style={{paddingTop:30}}>
        <div style={{textAlign:"center",marginBottom:40}}>
          <div style={{marginBottom:16}}>{F?<FuturisticCentaur/>:<ClassicalCentaur/>}</div>
          <h1 style={{fontSize:isMobile?(F?32:36):(F?44:48),fontWeight:F?800:400,lineHeight:1.12,margin:0,...(F?{background:"linear-gradient(135deg,#00F5D4,#FF006E,#FEE440)",WebkitBackgroundClip:"text",WebkitTextFillColor:"transparent"}:{})}}>{F?<>Stay informed.<br/>Stay human.</>:"The AI Centaur"}</h1>
        ...
        <div style={{display:"grid",gridTemplateColumns:isMobile?"1fr":(F?"1fr 1fr 1fr":"1fr 1fr"),gap:F?14:20}}>
        ...
        {BIG_QUESTIONS.map((bq,i)=>(<div key={i} style={{background:t.surface,border:`1px solid ${expQ===i?(F?topicColors[i]:t.borderActive):t.border}`,borderRadius:t.radius,marginBottom:10,overflow:"hidden",transition:"all 0.3s"}}>
          ...
          {expQ===i&&(<div style={{borderTop:`1px solid ${t.border}`,padding:"0 22px 22px"}}>
            ...
            {qTab==="discuss"&&(<div>
              ...
              {/* Discussion Prompt */}
              <div style={{background:t.accentBg,border:`1px solid ${t.borderActive}`,borderRadius:t.radius,padding:"16px 20px",margin:"16px 0"}}><div style={{fontSize:10,letterSpacing:3,color:t.accent,marginBottom:6,fontFamily:t.fontAlt}}>💬 DISCUSSION PROMPT{bq.prompts.length>1?"S":""}</div>{bq.prompts.map((p,k)=>(<div key={k} style={{fontSize:14,lineHeight:1.7,fontStyle:F?"normal":"italic",padding:k>0?"10px 0 0":"0",marginTop:k>0?10:0,borderTop:k>0?`1px solid ${t.borderActive}44`:"none"}}>{p}</div>))}</div>
            ...
            {/* FACTS TAB */}
            {qTab==="facts"&&(<div>
              <div style={{display:"grid",gridTemplateColumns:cols2,gap:10,marginBottom:20}}>
            ...
            {qTab==="verify"&&(<div>
              ...
              <div style={{background:t.accentBg,borderRadius:t.radius,padding:"12px 16px",marginTop:16,fontSize:11,color:t.textSec}}><strong>Last verified:</strong> {LAST_UPDATED}. Environment & Education were re-fact-checked most recently; every number traces to the sources above.</div>
            </div>)}
          </div>)}
        </div>))}
      </div>)}
      ...
      {page==="tracker"&&sub==="overview"&&(<div style={{paddingTop:10}}>
        ...
        <div style={{background:t.accentBg,border:`1px solid ${t.borderActive}`,borderRadius:t.radius,padding:"14px 18px",marginBottom:20}}>
          <div style={{fontSize:13,lineHeight:1.7,color:t.textSec}}>
            <strong style={{color:t.accent}}>What is ELO?</strong> — A rating system borrowed from chess. When two AI models are shown to real people side by side and one is preferred, its ELO goes up and the loser's goes down. Higher ELO = more preferred by humans in blind tests. The scores come from <a href="https://lmarena.ai" target="_blank" rel="noopener" style={{color:t.accent}}>Arena</a> (formerly Chatbot Arena / LMArena), which has collected millions of human votes. A "—" means the model isn't ranked on the main text leaderboard yet — brand-new models take weeks to accumulate votes, and some are only ranked on category boards (coding, vision, agents).
          </div>
        </div>
        <div style={{display:"grid",gridTemplateColumns:cols2,gap:12}}>
          {MODELS.map(m=>(<div key={m.id} style={{background:t.surface,border:`1px solid ${t.border}`,borderRadius:t.radius,padding:"18px 16px",position:"relative",overflow:"hidden"}}>
            ...
            <div style={{display:"flex",justifyContent:"space-between",alignItems:"flex-start",marginTop:2}}>
              ...
              <div style={{fontSize:14,fontWeight:700,color:m.elo?t.accent:t.textGhost}}>{m.elo??"—"}</div>
            </div>
            <div style={{fontSize:12,color:t.textSec,marginTop:8,lineHeight:1.5}}>✦ {m.best}</div>
            <div style={{fontSize:10,color:t.textMuted,marginTop:8}}>{m.input_price?`API: $${m.input_price}/$${m.output_price} per 1M tokens`:m.open?"Free (open source)":"Subscription / varies"}{m.context?` · ${m.context>=1e6?`${(m.context/1e6).toFixed(0)}M`:`${(m.context/1e3).toFixed(0)}K`} context`:""}</div>
          </div>))}
        </div>
      </div>)}
      ...
      {page==="tracker"&&sub==="rankings"&&(<div style={{paddingTop:10}}>
        ...
        <div style={{background:t.accentBg,borderRadius:t.radius,padding:"12px 16px",marginTop:8,fontSize:11,color:t.textSec,lineHeight:1.6}}>
          <strong>How grades work:</strong> Scores 1-100 → A+ (90+), A (85+), A- (80+), B+ (75+), B (70+). These are approximate grade bands drawn from independent benchmarks, not precise measurements or company claims. Last updated {LAST_UPDATED}. Cross-reference at <a href="https://lmarena.ai" target="_blank" rel="noopener" style={{color:t.accent}}>Chatbot Arena</a> and <a href="https://artificialanalysis.ai" target="_blank" rel="noopener" style={{color:t.accent}}>Artificial Analysis</a>.
        </div>
      </div>)}
      ...
      {page==="tracker"&&sub==="acceleration"&&(<div style={{paddingTop:10}}>
        ...
        {[
          ...
          {id:"elo",emoji:"📈",title:"Peak Arena ELO Over Time",summary:"The highest ELO score keeps climbing, and the gap between top models keeps shrinking — more competition at the frontier.",details:[
            ...
            {year:"Aug 2026",event:"Top ELO: ~1525; three models above 1500",detail:"A threshold once thought years away was crossed by three different labs in one summer."},
          ],source:"Arena (lmarena.ai) — millions of human votes"},
        ...
        <div style={{background:t.accentBg,borderRadius:t.radius,padding:"14px 18px",marginTop:16,fontSize:12,color:t.textSec,lineHeight:1.6}}>
          All data from verified, published sources. Last updated {LAST_UPDATED}. Auto-refresh from live sources is the next planned upgrade.
        </div>
      </div>)}

      {/* Tracker: Safety */}
      {page==="tracker"&&sub==="safety"&&(<div style={{paddingTop:10}}>
        <BackBtn/><PageTitle sub="FLI AI Safety Index, Summer 2026 edition. No company scored above C+ — and this time three received failing grades.">Safety & Ethics</PageTitle>
        {SAFETY_DATA.map(c=>(<div key={c.company} style={{background:t.surface,border:`1px solid ${t.border}`,borderRadius:t.radius,padding:"16px 20px",marginBottom:10}}>
          <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:10}}>
            ...
            <div style={{fontSize:22,fontWeight:800,color:c.grade.startsWith("A")||c.grade.startsWith("B")?t.accentGreen:c.grade.startsWith("C")?t.accent:t.accentRed}}>{c.grade}</div>
          </div>
        ...
        <div style={{background:"rgba(180,83,9,0.05)",border:"1px solid rgba(180,83,9,0.15)",borderRadius:t.radius,padding:"14px 18px",marginTop:12,fontSize:12,color:t.textSec,lineHeight:1.6}}><strong style={{color:"#B45309"}}>Key finding this edition:</strong> the expert panel reports that the leading labs have quietly softened earlier commitments to pause development at dangerous capability thresholds — safety pledges weakening even as capabilities accelerate. Three smaller labs (Mistral, Z.ai, Alibaba Cloud) were also graded: F, D−, and D−.</div>
        <div style={{background:t.accentBg,borderRadius:t.radius,padding:"14px 18px",marginTop:10,fontSize:12,color:t.textSec,lineHeight:1.6}}>Source: <a href="https://futureoflife.org" target="_blank" rel="noopener" style={{color:t.accent}}>FLI AI Safety Index (Summer 2026, published July 7)</a>. Independent expert panel; grades on a 4.0 scale across 6 domains. Next edition expected early 2027.</div>
      </div>)}
      ...
      {page==="tools"&&sub==="features"&&(<div style={{paddingTop:10}}>
        ...
        {matchingModels.map(m=>(<div key={m.id} style={{background:t.surface,border:`1px solid ${t.border}`,borderRadius:t.radius,padding:"14px 18px",marginBottom:8,display:"flex",alignItems:"center",gap:14}}>
          ...
          <div style={{fontSize:11,color:t.accent,flexShrink:0}}>{m.input_price?`$${m.input_price}/$${m.output_price}`:m.open?"Free":"Varies"}</div>
        </div>))}
      </div>)}
      ...
      {page==="tools"&&sub==="tryit"&&(<div style={{paddingTop:10}}>
        ...
        <div style={{background:t.surface,border:`1px solid ${t.border}`,borderRadius:t.radius,padding:20,marginBottom:24}}>
          <div style={{fontSize:14,fontWeight:700,marginBottom:4}}>Test a prompt against Claude</div>
          <div style={{fontSize:11,color:t.textMuted,marginBottom:12}}>Live call to Claude Sonnet 4.6. On the public site this needs your own API key — or use the free comparison sites below instead.</div>
          ...
          {showKey&&<div style={{marginTop:12}}><input type="password" value={apiKey} onChange={e=>setApiKey(e.target.value)} placeholder="sk-ant-… (optional — stays in your browser, never saved)" style={{width:"100%",background:t.surfaceAlt,border:`1px solid ${t.border}`,borderRadius:t.radius,padding:"10px 12px",color:t.text,fontSize:12,fontFamily:"inherit",boxSizing:"border-box"}}/><div style={{fontSize:10,color:t.textGhost,marginTop:4}}>Get a key at console.anthropic.com → API Keys. Pay-as-you-go; a test message costs well under a cent.</div></div>}
      ...
      {/* FOOTER */}
      <div style={{maxWidth:900,margin:"0 auto",padding:isMobile?"0 20px 20px":"0 40px 20px"}}>
